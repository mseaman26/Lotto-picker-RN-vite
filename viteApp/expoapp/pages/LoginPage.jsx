...
const LoginPage = () => {
    ...
    const [email, setEmail] = useState(import.meta.env.NODE_ENV === 'production' ? '' : 'c@a.com');
    const [password, setPassword] = useState(import.meta.env.NODE_ENV === 'production' ? '' : '!Q2w3e4r');
